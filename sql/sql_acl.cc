...
static plugin_ref get_auth_plugin(THD *thd, const LEX_CSTRING &name, bool *locked)
{
  ...
  *locked=true;
  return my_plugin_lock_by_name(thd->plugins_state, thd->lex,
...
bool acl_init(bool dont_read_acl_tables)
{
  ...
  */
  native_password_plugin= my_plugin_lock_by_name(global_plugins_state, 0,
           &native_password_plugin_name, MYSQL_AUTHENTICATION_PLUGIN);
  old_password_plugin= my_plugin_lock_by_name(global_plugins_state, 0,
